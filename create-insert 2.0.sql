...
insert into PRODOTTI( nome, tipo, descrizione, data_rilascio, prezzo,id_brand) 
values ( 'A110', 'macchina', '1102 kg - 1140 kg Peso a vuoto, 4,5 s Accelerazione da 0 a 100 km/h,
...
( 'Roma', 'macchina', 'Lunga 466 cm, larga 197 e alta 130, la Ferrari Roma ha linee frutto del lavoro svolto dal Centro Stile Ferrari coordinato da Flavio Manzoni. Ha forme fluide e moderne, capaci di intrecciare gli stilemi delle coupé dell epopea Rossa.',
'2019',  '217.100','1'),

('SL', 'macchina', 'L&#8217;altezza è quella tipica di una cabrio/coupè e arriva a 1.5 metri. Il passo di 2.7 metri, invece, permette di poter contare anche su due piccoli posti posteriori. Il bagagliaio, infine, ha una capacità che va dai 213 ai 240 litri a seconda della posizione del tetto.',  '1954',  '138.930','2'),

('Portachiave', 'accessorio', 'Portachiave con logo bmw',  '2010',  '18,99','3'),

('Cappuccio BMW', 'accessorio', 'Cappuccio per ruote brandizzato BMW',  '2023',  '25,99','3'),

('F8 Spider', 'macchina', 'Nella versione F8 Spider con motore a benzina di 3902 cc (Euro 6) capace di erogare una potenza massima di 530 kW/720 CV ed una coppia massima di 770 Nm a 3250 giri/min. La trazione è posteriore. Il serbatoio ha una capienza di 78 litri. L&#8217;accelerazione da 0 a 100 km/h avviene in 2.9 secondi.',  '2019',  '21.500','1');
...
values ('admin@fgms.it', '123staila', 'Admin', '', '', NULL, NULL, NULL, NULL, NULL, NULL),
('ambrogio@gmail.com', 'ambrogio', 'Ambrogio', 'De Girolamo', '3332221111', '84016', 'Via Sant Eustacchio, PEGANI', '71', NULL, NULL, NULL);
