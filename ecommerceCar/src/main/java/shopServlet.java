...
public class shopServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
			...
			try {
				...
				String query="select b.nome as nome_brand, p.nome as nome_prodotto, m.percorso, p.descrizione, p.prezzo, p.tipo from prodotti as p ,brand as b, media as m where p.id_brand=b.id and m.id_prodotto=p.id and p.id="+request.getParameter("id_prodotto")+";"; 
	            ...
	            if (resultSet.next()) {
	                ...
	                request.setAttribute("tipo", resultSet.getString("tipo"));
