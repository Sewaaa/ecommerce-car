...
<body>
    ...
    <form action="modifica_prodotto" method="post">
        ...
        <input type="text" value="" name="nome" id="nome" required><br><br>
        
        <label for="descrizione">Descrizione:</label>
        <input type="text" value="" name="descrizione" id="descrizione" required><br><br>

        <label for="data_rilascio">Data di Rilascio:</label>
        <input type="text" value="" name="data_rilascio" id="data_rilascio" required><br><br>

        <label for="prezzo">Prezzo:</label>
        <input type="text" value="" name="prezzo" id="prezzo" required><br><br>

        <label for="foto">Path Foto:</label>
        <input type="text" value="" name="percorso" id="percorso" required><br><br>

        <input type="hidden" name="id_prodotto" id="id_prodotto_input" value="">
        <input type="submit" value="Modifica">
    </form>

    <script>
        // Imposta i valori dei campi del form con i dati del prodotto ottenuti dal backend
        document.getElementById('id_prodotto_input').value = '<%=id%>';
        document.getElementById('nome').value = '<%=nome_prodotto%>';
        document.getElementById('descrizione').value = '<%=descrizione_prodotto%>';
        document.getElementById('data_rilascio').value = '<%=data_rilascio_prodotto%>';
        document.getElementById('prezzo').value = '<%=prezzo_prodotto%>';
        document.getElementById('percorso').value = '<%=path_p%>';
    </script>
